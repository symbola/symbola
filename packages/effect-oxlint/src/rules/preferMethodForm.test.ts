...
new RuleTester({
  ...
  invalid: [
    ...
    {
      code:
        "import { map } from \"@symbola/effect\"; import * as Effect from 'effect/Effect'; const result = Effect.map(self, f);",
      output:
    ...
    {
      code:
        "import { map } from \"@symbola/effect\"; import * as Effect from 'effect/Effect'; import { pipe } from 'effect/Function'; const result = pipe(self, Effect.map(f), Effect.flatMap(g));",
      output:
    ...
    {
      code:
        "import * as Effect from 'effect/Effect'; import { map } from 'effect/Effect'; const result = Effect.map(self, f);",
      output: null,
      errors: [{ message: error }]
    },
    {
    ...
    {
      code:
        "import type { map } from \"@symbola/effect\"; import * as Effect from 'effect/Effect'; const result = Effect.map(self, f);",
      output: null,
      errors: [{ message: error }]
    },
    {
      code:
        "import * as Effect from 'effect/Effect'; import { pipe } from 'effect/Function'; const result = pipe(self, Effect.map(f));",
      output:
    ...
    {
      code:
        "import * as Effect from 'effect/Effect'; import { pipe } from 'effect/Function'; const result = pipe(self, Effect.map(f), Effect.flatMap(g));",
      output:
    ...
    {
      code:
        "import * as Effect from 'effect/Effect'; import * as Option from 'effect/Option'; import { pipe } from 'effect/Function'; const result = pipe(self, Effect.map(f), Option.map(g));",
      output: null,
      errors: [{ message: error }, { message: error }]
    },
    {
      code:
        "import * as Effect from 'effect/Effect'; import { pipe as flow } from 'effect/Function'; const result = flow(self, Effect.map(f));",
      output:
    ...
    {
      code:
        "import * as Result from 'effect/Result'; const result = Result.filterOrFail(value, predicate, orFailWith);",
      output:
    ...
    {
      code:
        "import * as Schema from 'effect/Schema'; import { pipe } from 'effect/Function'; const result = pipe(Schema.String, Schema.brand('InternalId'));",
      output:
    ...
    {
      code:
        "import * as SchemaParser from 'effect/SchemaParser'; const result = SchemaParser.decodeUnknownResult(schema, input);",
      output:
    ...
    {
      code:
        "import * as Effect from 'effect/Effect'; import { pipe } from 'effect/Function'; const result = pipe(self, Effect.map(f), other);",
      output: null,
      errors: [{ message: error }]
    },
    {

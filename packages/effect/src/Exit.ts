...
abstract class ExitProtocol<A, E> {
  ...
  [flatMap]<B, E2>(this: Ex<A, E>, f: (value: A) => Ex<B, E2>): Ex<B, E | E2> {
    return Exit.isSuccess(this) ? f(this.value) : (this as unknown as Ex<B, E | E2>)
  }
  ...
  [match]<B, C>(
    ...
    options: {
      readonly onFailure: (
        cause: Exit.Exit<never, E> extends Exit.Exit<never, infer E0> ? import("effect/Cause").Cause<E0>
          : never
      ) => B

...
declare module "effect/HashSet" {
  interface HashSet<out Value, out A extends Value = Value> extends HashSetProtocol<A> {}
}
...
Effect.runSync(install(HashSetProtocol.prototype, prototypeOf(HashSet.make(0))))

...
installProperty(Object.prototype, tryPromise, function(this: () => PromiseLike<unknown>) {
  return Effect.tryPromise(this)
})

installProperty(Object.prototype, promise, function(this: () => PromiseLike<unknown>) {
  return Effect.promise(this)
})

installProperty(Function.prototype, gen, function(this: EffectGeneratorFunction) {

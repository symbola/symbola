...
describe("stream symbol protocol", () => {
  ...
  describe("[flatMap]", () => {
    it.effect("is equivalent to Stream.flatMap", () =>
      Effect.gen(function* () {
        ...
        const after = yield* stream[flatMap]((v) => Stream.make(v, v * 10))[
          runCollect
        ]();
  ...
  describe("[tap]", () => {
    it.effect("is equivalent to Stream.tap", () =>
      Effect.gen(function* () {
        ...
        seen.length = 0;
        const after = yield* stream[tap]((v) =>
          Effect.sync(() => seen.push(v)),
        )[runCollect]();
  ...
  describe("installation", () => {
    it("installs shared methods on Object.prototype as non-enumerable properties", () => {
      expect(
        Object.getOwnPropertyDescriptor(Object.prototype, map),
      ).toMatchObject({
        enumerable: false,
        writable: true,
        configurable: true,

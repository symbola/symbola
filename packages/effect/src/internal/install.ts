...
export type SymbolProtocolImplementation = (
  ...args: readonly never[]
) => unknown;
...
const isEntryIterable = (
  protocol: SymbolProtocol,
): protocol is Iterable<SymbolProtocolEntry> =>
  Symbol.iterator in protocol &&
  typeof protocol[Symbol.iterator] === "function";
